...
for d in range(len(timestamp_list)-1):
    ...
    filename = f'thermal_w_renew_{start_datetime.strftime("%Y%m%d")}_{end_datetime.strftime("%Y%m%d")}.csv'
    ...
    filename = f'nygrid_sim_w_renew_{start_datetime.strftime("%Y%m%d")}_{end_datetime.strftime("%Y%m%d")}.pkl'
